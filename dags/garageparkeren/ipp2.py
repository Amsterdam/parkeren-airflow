...
with DAG(
    ...
    staging_to_his = generate_job(
        f"ipp2-sta-to-his-{timestamp_str}"[:MAX_JOB_NAME_LENGTH].rstrip("-"),
        NAMESPACE,
        IMAGE,
    ...
    run_staging_to_his = JobOperator(job=staging_to_his, task_id="run-ipp2-sta-to-his")

    watch_staging_to_his: BaseOperator = JobSensor(
        job_name=staging_to_his.metadata.name,
        task_id="watch-ipp2-sta-to-his",
        namespace=NAMESPACE,
